...
[![Deploy to Azure](http://azuredeploy.net/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.github.com%2Fstm605%2FSAP-HANA-LEG%2Fmaster%2Fazuredeploy.json)

[![LaMa](http://azuredeploy.net/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.github.com%2Fstm605%2FSAP-HANA-LEG%2Fmaster%2Flama.json)
## Machine Info
...
## Installation Media
Installation media for SAP HANA should be downloaded and placed in the SapBits folder. You will need to provide the URI for the container where they are stored, for example https://yourBlobName.blob.core.windows.net/yourContainerName. For more information on how to upload files to Azure please go [here](https://github.com/stm605/SAP-HANA-LEG/blob/master/UploadToAzure.md)  Specifically you need to download SAP package 51052325, which should consist of four files:
```
51052325_part1.exe
51052325_part2.rar
51052325_part3.rar
...
![SapBits Image](https://github.com/stm605/SAP-HANA-LEG/blob/master/media/Structure1.png)

The following files should be present inside the SapBits folder:

![HANA Image](https://github.com/stm605/SAP-HANA-LEG/blob/master/media/Structure2.png)
...
![HANA Studio Image](https://github.com/stm605/SAP-HANA-LEG/blob/master/media/Structure3.png)

## Deploy the Solution
### Deploy from the Portal

To deploy from the portal using a graphic interface you can use the [![Deploy to Azure](http://azuredeploy.net/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.github.com%2Fstm605%2FSAP-HANA-LEG%2Fmaster%2Fazuredeploy.json) button to bring up the template in your subscription and fill out the parameters.
...
New-AzureRmResourceGroupDeployment -Name HANADeployment -ResourceGroupName HANADeploymentRG `
  -TemplateUri https://raw.github.com/stm605/SAP-HANA-LEG/master/azuredeploy.json `
...
az group deployment create \
    ...
    --template-uri "https://raw.github.com/stm605/SAP-HANA-LEG/master/azuredeploy.json" \
...
![Directories](https://github.com/stm605/SAP-HANA-LEG/blob/master/media/directories.png)
...
![Directories2](https://github.com/stm605/SAP-HANA-LEG/blob/master/media/directories2.png)

Select the option of "Build your own template in the editor"

![Directories3](https://github.com/stm605/SAP-HANA-LEG/blob/master/media/directories3.png)

Copy the contents from the azuredeploy.json [file](https://raw.github.com/stm605/SAP-HANA-LEG/master/azuredeploy.json) and paste them into the template editor, click Save.

![Directories4](https://github.com/stm605/SAP-HANA-LEG/blob/master/media/directories4.png)
